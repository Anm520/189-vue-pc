<template>
    <a-modal :open="open" :wrap-style="{ overflow: 'hidden' }" class="ant-modal-dray">
        ...
        <createFolderModel v-model="showCreateFolderModel" :parentFolderId="selectRow.id" @update="handleCreateFolder" :folderName="taskName" />
    </a-modal>
</template>
<script setup>
