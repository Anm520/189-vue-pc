<template>
    <div class="card">
        ...
        <div class="card-download">
            <a-space>
                <a-button type="primary" size="small" v-for="(link, index) in channel.download_links" @click='handleClick(link.url)'>{{ link.type }}</a-button>
            </a-space>
...
const props = defineProps({
    channel: {
        ...
        default: () => {
            return {
                author: '🎯Just Silence',
                download_links: [{ type: '主链', url: 'https://cloud.189.cn/t/q6777zqIRZNb' }],
                id: '2436',
                image_url:
                ...
                size: '',
                tags: ['仁心俱乐部', '连续剧'],
                text: '仁心俱乐部（2025）辛芷蕾 白客主演 4K 更至 EP32',
